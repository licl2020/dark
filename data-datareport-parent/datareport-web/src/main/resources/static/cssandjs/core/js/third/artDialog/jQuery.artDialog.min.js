...
(function(h, k, l) {
		...
		if(flag){
			...
			return this.each(function(){
				if(browser.msie || browser.safari){
					h(this).unbind('selectstart');
				}
				else if(browser.mozilla){
					h(this).css('MozUserSelect', 'inherit');
				}
				else if(browser.opera){
					h(this).unbind('mousedown');
				}
				else{
					h(this).removeAttr('unselectable', 'on');
				}
			});
		}
	};
    ...
    e.fn = e.prototype = {
        constructor: function(a) {
			...
			b['resize-Small'][(a.size === false) ? "hide": "show"]();
        ...
        close: function() {
            ...
            if (m) b.remove();
				...
				console.log(a['resize-Small'])
				a['resize-Small'][0].className = "d-resize-Small";
                b.css({
                    left: 0,
                    top: 0,
        ...
        _getDom: function() {
            ...
            a.insertBefore(b, a.firstChild);//添加HTML到BODY
            for (var c = 0,
            d = {},
		...
		_size:function(a,width,height){
			if(h(this).hasClass("d-resize-Big")){
				this.title="窗口最大化";
				a.size(width,height);
				h('iframe',a.dom.content).width(width);
				h('iframe',a.dom.content).height(height);
				a.position();
				h(this).removeClass("d-resize-Big");	
			}else{
				this.title="恢复窗口";
				var Width=document.documentElement.clientWidth,Height=document.documentElement.clientHeight-30;
				a.dom.wrap[0].style.left='0px';
				a.size(Width,Height).position();
				h('iframe',a.dom.content).width(Width);
				h('iframe',a.dom.content).height(Height);
				h(this).addClass("d-resize-Big");	
			}
		},
        _addEvent: function() {
            var a = this,
			...
			height=b['content'].height();
            b.wrap.bind("click",
            function(c) {
                c = c.target;
				if(c == b['resize-Small'][0]){
					a._size.call(c,a,width,height);	
				}
    ...
    e._templates = '<div class="d-outer"><table class="d-border"><tbody><tr><td class="d-nw"></td><td class="d-n"></td><td class="d-ne"></td></tr><tr><td class="d-w"></td><td class="d-c"><div class="d-inner"><table class="d-dialog"><tbody><tr><td class="d-head"><div class="d-head-inner"><div class="d-title"></div><a class="d-resize-Small" href="javascript:/*artDialog*/;" title="窗口最大化">\u00d7</a><a class="d-close" href="javascript:/*artDialog*/;" title="\u5173\u95ed">\u00d7</a></div></td></tr><tr><td class="d-main"><div class="d-content"></div></td></tr><tr><td class="d-foot"><div class="d-buttons"></div></td></tr></tbody></table></div></td><td class="d-e"></td></tr><tr><td class="d-sw"></td><td class="d-s"></td><td class="d-se"></td></tr></tbody></table></div>';
    e.defaults = {
