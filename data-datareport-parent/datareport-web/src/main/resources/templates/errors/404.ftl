...
<head>
    ...
    <style>
        ...
        font-face {
            ...
            src: url('texgyreschola-bold-webfont.eot?#iefix') format('embedded-opentype'), url('texgyreschola-bold-webfont.woff') format('woff'), url('texgyreschola-bold-webfont.ttf') format('truetype'), url('texgyreschola-bold-webfont.svg#TeXGyreScholaBold') format('svg');
            font-weight: normal;
            font-style: normal;
        }
...
<body>
    <div id="wrapper">
        ...
        <div id="main">
            <header id="header">
                <h1><span class="icon">!</span>异常<span class="sub">${content!"非法访问，请正确访问"}</span></h1>
            </header>
            <div id="content">
                <h2>页面开小差...</h2>
                <div class="utilities">
                    <a class="button right" href="${request.contextPath}/index" target="_top">返回上一页...</a>
                    <div class="clear"></div>
                </div>
            </div>
            <div id="footer">
