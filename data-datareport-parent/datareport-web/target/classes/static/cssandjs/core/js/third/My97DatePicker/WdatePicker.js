...
var $dp, WdatePicker; (function() {
    ...
    s; (s = u.match(/msie ([\d.]+)/)) ? n.ie = s[1] : (s = u.match(/firefox\/([\d.]+)/)) ? n.firefox = s[1] : (s = u.match(/chrome\/([\d.]+)/)) ? n.chrome = s[1] : (s = u.match(/opera.([\d.]+)/)) ? n.opera = s[1] : (s = u.match(/version\/([\d.]+).*safari/)) ? n.safari = s[1] : 0;
    /*用于浏览器类型及版本判断*/
