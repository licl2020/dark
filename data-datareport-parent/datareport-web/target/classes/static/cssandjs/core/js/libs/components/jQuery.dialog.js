 ...
 * Modified contents: 
**/
window.core.includeCss(cuurrent_host+'/cssandjs/core/js/third/artDialog/dialog.css');
window.core.includeJs(cuurrent_host+'/cssandjs/core/js/third/artDialog/jQuery.artDialog.min.js', function(){
	var
